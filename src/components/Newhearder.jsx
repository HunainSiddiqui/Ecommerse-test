...
class PrimarySearchAppBar extends React.Component {
  ...
  render() {
    ...
    const renderMenu = (
      ...
      >
        <MenuItem onClick={this.handleMenuClose}><Link className="dropdown-item" to="/account/signin">
                      <svg
        ...
        <MenuItem onClick={this.handleMenuClose}><Link className="dropdown-item" to="/account/signup">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    <MenuItem onClick={this.handleMenuClose}> <Link className="dropdown-item" to="/account/profile">
          ...
          <Toolbar>
            ...
            <div className={classes.sectionDesktop}>
              <IconButton color="inherit">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-basket-fill" viewBox="0 2 16 16">
